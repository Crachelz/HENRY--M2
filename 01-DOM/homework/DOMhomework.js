...
var addMyName = document.getElementById("createdBy")
addMyName.innerHTML = 'Aplicación creada por: Carolina'


// Crear una clase denominada 'ToDo' cuyo constructor debe recibir un único parámetro del tipo 
//string
...
//    1) Crear un elemento 'div' y asignárselo a una variable denominada 'toDoShell'  //doc.createelement
//    2) Asignarle a 'toDoShell' la clase 'toDoShell'
//    3) Crear un elemento 'span' y asignárselo a una variable denominada 'toDoText' //createelement
...
//    7) Agregar 'toDoText' como hijo de 'toDoShell' // appendchild
...
function buildToDos(toDos) {//recibe array
  // Tu código acá:
...
function addToDo() {
  ...
  if (input.value !== ''){ // -> Test pasa sin el  If, es una verificación adicional para que no se nos agreguen arrays vacios
...
//  (Esta parte ya se
// encuentra desarrollada pero está comentada dentro de la función por lo que va a ser necesario 
//  que la descomenten)]
//   1) Utilizando el index suministrdo, llamar a 'completeToDo' (Recuerden que habíamos creado 
//  dcho método en el
